...
from func.src.domain.exceptions.exceptions import InternalServerError, ErrorOnDecodeJwt
...
from func.src.services.users.service import UserService
...
async def update_w8_ben_signature(
    ...
    try:
        response = await UserService.update_w8_form_confirmation(payload=payload)
        return response
